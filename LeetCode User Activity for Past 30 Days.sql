Create table Activity1 (user_id int, session_id int, activity_date date, activity_type varchar(30) check (activity_type in ('open_session', 'end_session', 'scroll_down', 'send_message')))
